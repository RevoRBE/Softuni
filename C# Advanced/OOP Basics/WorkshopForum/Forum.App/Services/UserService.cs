...
namespace Forum.App.Services
{
    public static class UserService
    {
        ...
        public static SignUpStatus TrySignUpUser(string username, string password)
        {
            ...
            if (!validUsername || !validPassword) return SignUpStatus.DetailsError;
        ...
        {
            ForumData forumData = new ForumData();
            return forumData.Users.Find(u => u.Id == userId);
        }

         internal static User GetUser(string userName)
        {
            ForumData forumData = new ForumData();
            return forumData.Users.Find(u => u.Username == userName);
        }
    }
}
